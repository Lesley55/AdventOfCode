...
function start() {
    ...
    for (let i = 0; i < input.length; i++) {
        // forward
        if(input[i].substring(0,1) == "F") {
            input[i] = dir + input[i].substring(1)
        }

        // right and left
        let a = input[i].substring(0,1)
        let b = parseInt(input[i].substring(1))
        if(b == "90") { // verkeerd gelezen, kan dit beter oplossen met functie of klass, maar kopieren plakken gaat sneller
            if((a == "R" && dir == "W") || (a == "L" && dir == "E")) {
                dir = "N"
            } else if((a == "R" && dir == "N") || (a == "L" && dir == "S")) {
                dir = "E"
            } else if((a == "R" && dir == "E") || (a == "L" && dir == "W")) {
                dir = "S"
            } else if((a == "R" && dir == "S") || (a == "L" && dir == "N")) {
                dir = "W"
            }
        } else if(b == "180") {
            if((a == "R" && dir == "S") || (a == "L" && dir == "S")) {
                dir = "N"
            } else if((a == "R" && dir == "W") || (a == "L" && dir == "W")) {
                dir = "E"
            } else if((a == "R" && dir == "N") || (a == "L" && dir == "N")) {
                dir = "S"
            } else if((a == "R" && dir == "E") || (a == "L" && dir == "E")) {
                dir = "W"
            }
        } else if(b == "270") {
            if((a == "R" && dir == "E") || (a == "L" && dir == "W")) {
                dir = "N"
            } else if((a == "R" && dir == "S") || (a == "L" && dir == "N")) {
                dir = "E"
            } else if((a == "R" && dir == "W") || (a == "L" && dir == "E")) {
                dir = "S"
            } else if((a == "R" && dir == "N") || (a == "L" && dir == "S")) {
                dir = "W"
            }
