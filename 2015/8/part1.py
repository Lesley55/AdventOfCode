...
for i in input:
    # i = repr(i)
    # i = re.escape(i)
    # i = re.escape(repr(i)[1:-1]).replace('\\\\', '\\')
    # i = r"{}".format(i)
    i = i[:-1]
    # print(i)

####################################################################################################################################################################################
# thought it would work, but can't get raw characters from string, need to read them from input file, but somehow open("input.txt") can't find file, so i can't solve it
####################################################################################################################################################################################
