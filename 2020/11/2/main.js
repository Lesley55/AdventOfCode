    ...
    while(change) {
        ...
        for (let y = 1; y < input.length-1; y++) {
            for (let x = 1; x < input[y].length-1; x++) {
                // count first seat in rows
                let a = 0
                for (let j = y+1; j < input.length-1; j++) { // onder
                    if(input[j][x] == "#") {
                        a++
                        break
                    } else if(input[j][x] == "L") {
                ...
                for (let j = x+1; j < input[y].length-1; j++) { // rechts
                    if(input[y][j] == "#") {
                        a++
                        break
                    } else if(input[y][j] == "L") {
                ...
                // rechts boven
                let rbl
                if(y < input[y].length-x) {
                    rbl = y
                } else {
                    rbl = input[y].length-x
                }
                for (let j = 1; j < rbl; j++) {
                    if(input[y-j][x+j] == "#") {
                        a++
                ...
                // rechts onder
                let rol
                if(input.length-y < input[y].length-x) {
                    rol = input.length-y
                } else {
                    rol = input[y].length-x
                }
                for (let j = 1; j < rol; j++) {
                    if(input[y+j][x+j] == "#") {
                        a++
        ...
        for (let q = 0; q < input.length; q++) {
            input[q] = JSON.parse(JSON.stringify(andere[q]))
        }
    }
