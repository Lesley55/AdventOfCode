...
function start() {
    ...
    while (true) {
        if(i >= input.length) {
            ...
            break;
        } else if(past.includes(i)) {
            console.log("broke", i)
            break;
        } else {
            past.push(i)
            if(input[i].substring(0,3) == "nop") {
                i++
            } else if (input[i].substring(0,3) == "acc") {
                if(input[i].substring(4,5) == "+") {
                    accumulator += parseInt(input[i].substring(5))
                } else if(input[i].substring(4,5) == "-") {
                    accumulator -= parseInt(input[i].substring(5))
                }
                i++
            } else if (input[i].substring(0,3) == "jmp") {
                if(input[i].substring(4,5) == "+") {
                    i += parseInt(input[i].substring(5))
                } else if(input[i].substring(4,5) == "-") {
                    i -= parseInt(input[i].substring(5))
                }
            }
