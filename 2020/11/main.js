...
let input = ["L.LL.LL.LL", "LLLLLLL.LL", "L.L.L..L..", "LLLL.LL.LL", "L.LL.LL.LL", "L.LLLLL.LL", "..L.L.....", "LLLLLLLLLL", "L.LLLLLL.L", "L.LLLLL.LL"]
let andere = []
...
function start() {
    ...
    for (let i = 0; i < input.length; i++) {
        andere[0].push(".")
        andere.splice([i+1], 1, [".", ...input[i].split(""), "."])
        andere[andere.length-1].push(".")
    }
    andere[0].push(".")
    andere[andere.length-1].push(".")
    input.splice(0, input.length, ...andere);
    ...
    while(change) {
        ...
        for (let y = 1; y < input.length-1; y++) {
            for (let x = 1; x < input[y].length-1; x++) {
                ...
                console.log(input[y-1][x-1], input[y-1][x], input[y-1][x+1])
                console.log(input[y][x-1], input[y][x], input[y][x+1])
                console.log(input[y+1][x-1], input[y+1][x], input[y+1][x+1])
